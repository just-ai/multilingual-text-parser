...
class Preprocessor:
    def __init__(self, batch_size=1):
        ...
        self.predictor = None  # RNNMorphPredictor(language="ru")
    ...
    def gettags(self, texts):
        ...
        if self.predictor and len(all_phrases_for_rnnmorph) > 0:
